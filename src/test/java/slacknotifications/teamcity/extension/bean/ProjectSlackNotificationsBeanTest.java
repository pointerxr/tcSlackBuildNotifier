...
public class ProjectSlackNotificationsBeanTest {
	...
	public void JsonSerialisationTest() throws JDOMException, IOException {
		...
		framework.loadSlackNotificationProjectSettingsFromConfigXml(new File("src/test/resources/project-settings-test-all-states-enabled-with-specific-builds.xml"));
